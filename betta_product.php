...
<div class="container">
    ...
    <section class="products">
        ...
        <div class="betta">
            ...
            <p class="betta-description">
                The Siamese fighting fish, commonly known as the betta, is a freshwater fish native to Southeast Asia.
                <br><br>
                Lifespan: 2-5 years
                <br>
        ...
        <div class="box-container">
            <?php
            // Select products with category 'betta' and calculate average rating
            $select_products = mysqli_query($conn, 
            "SELECT p.*, IFNULL(AVG(r.rating), 0) as avg_rating 
            FROM products p
            LEFT JOIN reviews r ON p.id = r.product_id 
            WHERE p.category = 'betta' 
            GROUP BY p.id"
            ...
            if (mysqli_num_rows($select_products) > 0) {
                while ($fetch_products = mysqli_fetch_assoc($select_products)) {
                    ...
                    ?>
                    <div class="box">
                        <img class="image" src="uploaded_img/<?= $fetch_products['image']; ?>" alt="Betta Fish">
                        <div class="rating">
                            <?php
                            for ($i = 1; $i <= 5; $i++) {
                                if ($i <= $average_rating) {
        ...
        <div id="review-modal" class="modal">
            <div class="modal-content">
                ...
                <form action="submit_review.php" method="post">
                    ...
                    <input type="hidden" name="current_page" value="<?= $_SERVER['PHP_SELF']; ?>"> <!-- Current page URL -->
