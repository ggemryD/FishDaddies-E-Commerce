...
<div class="container">
    ...
    <div class="heading">
        <!-- <h3>Our Goldfish Shop</h3> -->
    </div>

    <section class="products">
        <h1 class="title">Goldfish</h1>
        <div class="goldfish">
            <img src="goldfish/goldfishfriends.avif" alt="Goldfish" class="goldfish-image">
            <p class="goldfish-description">
        ...
        <div class="box-container">
            ...
            if (mysqli_num_rows($select_products) > 0) {
                while ($fetch_products = mysqli_fetch_assoc($select_products)) {
                    ...
                    ?>
                    <div class="box">
                        <img class="image" src="uploaded_img/<?= $fetch_products['image']; ?>" alt="Goldfish">
                        <div class="rating">
                            <?php
                            for ($i = 1; $i <= 5; $i++) {
                                if ($i <= $average_rating) {
                ...
                echo '<p class="empty">No Goldfish products available!</p>';
            }
            ?>
        </div>
