...
//    $update_category = $_POST['update_category']; // Use category from dropdown
...
<div class="container">
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <!-- New input for product description -->
         ...
         if (mysqli_num_rows($select_products) > 0) {
            while ($fetch_products = mysqli_fetch_assoc($select_products)) {
               ...
               <div class="box">
                  ...
                  <div class="stock" style="font-size: 15px;">Stock: <?php echo $fetch_products['stock']; ?></div> <!-- Display stock quantity -->
            ...
            while ($fetch_update = mysqli_fetch_assoc($update_query)) {
               ...
               <!-- <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <select name="update_category" class="box" required>
                   ...
                   New input for updating product description 
